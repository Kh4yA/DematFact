 ...
 */
final class Version20250227131351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE tel_protable tel_portable VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE tel_portable tel_protable VARCHAR(255) DEFAULT NULL');
