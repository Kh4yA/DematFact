 ...
 */
final class Version20250227140339 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE tel_portable tel_portable VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE tel_portable tel_portable VARCHAR(255) DEFAULT NULL');
